...
exports.ReviewsManagementController = exports.ReviewsController = void 0;
...
let ReviewsController = class ReviewsController {
    ...
    findProductReviews(productId, page = 1, limit = 10) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ReviewsController.prototype, "findProductReviews", null);
exports.ReviewsController = ReviewsController = __decorate([
    (0, common_1.Controller)('products/:productId/reviews'),
    __metadata("design:paramtypes", [reviews_service_1.ReviewsService])
], ReviewsController);
let ReviewsManagementController = class ReviewsManagementController {
    reviewsService;
    constructor(reviewsService) {
        this.reviewsService = reviewsService;
    }
...
exports.ReviewsManagementController = ReviewsManagementController;
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], ReviewsManagementController.prototype, "findOne", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:returntype", void 0)
], ReviewsManagementController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:returntype", void 0)
], ReviewsManagementController.prototype, "remove", null);
exports.ReviewsManagementController = ReviewsManagementController = __decorate([
